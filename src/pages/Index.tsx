            ...
            <div className="flex items-center justify-center lg:justify-start">
              <div className="text-center lg:text-left">
                <img 
                  src="/lovable-uploads/938ec48e-ee62-43b3-9547-0f51ac679f34.png" 
                  alt="Growing Smiles Children's Dentistry Logo" 
                  className="h-48 lg:h-64 xl:h-80 w-auto mx-auto lg:mx-0 drop-shadow-2xl"
                />
                <div className="mt-8 p-6 bg-white/80 backdrop-blur-sm rounded-2xl shadow-lg">
                  <h3 className="text-2xl lg:text-3xl font-bold text-gray-900 mb-2">Growing Smiles</h3>
          ...
          <div className="grid lg:grid-cols-3 gap-8 items-center">
            ...
            <div className="hidden lg:flex justify-center">
              <div className="text-center">
                <img 
                  src="/lovable-uploads/938ec48e-ee62-43b3-9547-0f51ac679f34.png" 
                  alt="Growing Smiles Logo" 
                  className="h-40 w-auto mx-auto mb-4 drop-shadow-lg"
                />
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 p-4 rounded-xl">
                  <p className="text-sm font-semibold text-gray-700">Trusted Pediatric Care</p>
                </div>
              </div>
            </div>
            ...
            <div className="hidden lg:flex justify-center">
              <div className="text-center">
                ...
                />
                <div className="bg-gradient-to-br from-blue-50 to-teal-50 p-4 rounded-xl">
                  <p className="text-sm font-semibold text-gray-700">Gentle & Caring</p>
                </div>
              </div>
            </div>
